...
Este repositório não faz jus ao trabalho que o sustenta. Cada linha dele se apoia em código, documentação e conhecimento que outras pessoas escreveram, testaram, debateram e publicaram de graça, ao longo de décadas, em lugares diferentes, com origens, etnias, religiões, paixões e culturas diferentes, muitas vezes sem nome em lugar nenhum. A quem manteve um projeto depois do horário, respondeu uma issue de um desconhecido, escreveu o tutorial que destravou alguém, ou só deixou o código aberto para que outros aprendessem com ele: obrigado. A lista abaixo é o que dá para nomear; o resto, invisível, é a maior parte.

Ao [movimento do software livre e de código aberto](https://www.gnu.org/philosophy/free-sw.html) e à [Free Software Foundation](https://www.fsf.org/), pela ideia de que um programa deve poder ser estudado, modificado e compartilhado, e pela GPL que este projeto adota. Ao [Linux](https://kernel.org/) e a quem o mantém, pelo kernel em que tudo isto roda. À [OpenSSL](https://www.openssl.org/) e ao [OpenSSH](https://www.openssh.com/), pela criptografia e pelo acesso que protegem o node em silêncio. Ao [Renovate](https://docs.renovatebot.com/), por fazer sozinho, todo dia, a parte mais tediosa de manter um repositório vivo.

Pela infraestrutura e hospedagem: ao [GitHub](https://github.com/), que guarda o repositório, roda a CI, publica a documentação nas Pages e as imagens no GHCR; à [Cloudflare](https://www.cloudflare.com/), pelo DNS e pelo túnel que expõe os serviços sem abrir porta; ao [Docker Hub](https://hub.docker.com/), ao [Quay](https://quay.io/) e ao GHCR, que distribuem as imagens; ao [PyPI](https://pypi.org/) e ao [npm](https://www.npmjs.com/), que distribuem as ferramentas; ao [Shields.io](https://shields.io/), pelas badges; ao [Wikimedia Commons](https://commons.wikimedia.org/), por hospedar o logo da GPL; e ao [CRDs-catalog da Datree](https://github.com/datreeio/CRDs-catalog), pelos schemas que validam os manifestos na CI.
...
| [GNU coreutils](https://www.gnu.org/software/coreutils/) | Os utilitários básicos de que todo script e toda role dependem | [GPL-3.0-or-later](https://git.savannah.gnu.org/cgit/coreutils.git/tree/COPYING) | [GNU Project](https://www.gnu.org/software/coreutils/coreutils.html) |
| [GNU Bash](https://www.gnu.org/software/bash/) | O shell dos scripts em `.tools/` e das tasks `shell` do Ansible | [GPL-3.0-or-later](https://git.savannah.gnu.org/cgit/bash.git/tree/COPYING) | [GNU Project](https://www.gnu.org/software/bash/) |
| [GNU grep](https://www.gnu.org/software/grep/) | Os gates de prosa, imagem pinada e versão dependem dele | [GPL-3.0-or-later](https://git.savannah.gnu.org/cgit/grep.git/tree/COPYING) | [GNU Project](https://www.gnu.org/software/grep/) |
