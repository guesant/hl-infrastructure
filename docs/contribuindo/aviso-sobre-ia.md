...
Uma versão resumida deste aviso aparece fixa no topo de toda página deste site, com um link para esta página; quem chegou aqui clicando nele já viu o resumo e está lendo a versão completa.
