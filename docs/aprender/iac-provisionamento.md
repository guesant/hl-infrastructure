...
**Gestão de configuração** parte de uma máquina que já existe e configura o que roda dentro dela: quais pacotes instalar, quais arquivos escrever, quais serviços habilitar. [Ansible](ansible.md), Puppet, Chef e Salt são dessa família.
