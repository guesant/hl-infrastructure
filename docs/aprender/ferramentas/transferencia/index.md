...
[rsync](rsync.md) sincroniza em uma direção. [SSHFS](sshfs.md) monta filesystem remoto. [SFTP](sftp.md) oferece sessão de transferência. [rclone](rclone.md) integra múltiplos backends de storage.
