...
fundamentais do Kubernetes.

O conceito de namespace do kernel Linux continua documentado separadamente em
[Processo, namespaces e usuários num container](processo-namespaces-e-usuarios.md).
