...
Ele grava o token recifrado no manifest direto `argocd/apps/secrets/satellites/cloudflared/tunnel-token.sops-secret.yaml` com `sops set --idempotent`, sem chart intermediário e sem arquivo em texto claro.
